...
<html>
  ...
  <body>
    <div id="topPanel" >
      ...
      <div id="avatarHolder">
          <img id="avatarImage" src="avatar1.jpg" alt="avatar image" height="200px" width="200px" style="border-radius: 12px;" > 
      </div>
    </div>
    <div id="formPanel">
    <form id="frmChat" action="#" > 
      ...
      <div class="formRow">
        ...
        <div class="column2" ><input type="text" id="txtUser" name="user" size="10" value="" /></div>
	...
	<a href="https://github.com/AlaricSchenck/Alarics-chatscript-deli">Github Client Files</a>
	Powered by Chatscript by Bruce Wilcox.  
        <a href="http://sourceforge.net/projects/chatscript/">Download Chatscript</a> 
        </div>
    </div>
    <!--------------------------------------------------------------------------------------------------->
